...
#[test]
fn everything_1239d() {
    test_with_extra_checks_32_64(Path::new("1239d.exe"), |_ctx, _analysis| {
    });
}

#[test]
fn everything_12310a() {
    test_with_extra_checks_32_64(Path::new("12310a.exe"), |_ctx, _analysis| {
    });
}

#[test]
fn everything_12310b() {
    test_with_extra_checks_32_64(Path::new("12310b.exe"), |_ctx, _analysis| {
    });
}

#[test]
fn everything_12310c() {
    test_with_extra_checks_32_64(Path::new("12310c.exe"), |_ctx, _analysis| {
    });
}

#[test]
fn everything_12310d() {
    test_with_extra_checks_32_64(Path::new("12310d.exe"), |_ctx, _analysis| {
    });
}
...
#[test]
fn everything_12310f() {
    test_with_extra_checks_32_64(Path::new("12310f.exe"), |_ctx, _analysis| {
    });
}

#[test]
fn everything_12310g() {
    test_with_extra_checks_32_64(Path::new("12310g.exe"), |_ctx, _analysis| {
    });
}
